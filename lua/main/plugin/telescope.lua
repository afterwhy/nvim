...
keymap('n', '<leader>of', builtin.find_files, { desc = 'Telescope find files' })
keymap('n', '<M-o>', builtin.find_files, { desc = 'Telescope find files' })
keymap('n', '<M-щ>', builtin.find_files, { desc = 'Telescope find files' })
keymap('n', '<leader>f', builtin.live_grep, { desc = 'Telescope live grep' })
keymap('n', '<M-f>', builtin.live_grep, { desc = 'Telescope live grep' })
keymap('n', '<M-а>', builtin.live_grep, { desc = 'Telescope live grep' })
